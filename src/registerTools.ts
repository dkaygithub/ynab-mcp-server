...
/** Registers every YNAB tool on the given MCP server, wired to the YNAB API client. */
...
/** Builds a fresh MCP server with all YNAB tools registered. */
export function buildServer(api: ynab.API): McpServer {
